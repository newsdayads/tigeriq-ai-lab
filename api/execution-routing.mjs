...
const PHYSICAL_ACTIONS = [
  ...
  /(?:cài đặt|cài|gỡ|install|uninstall|update|nâng cấp)/i,
...
const EXPLICIT_PHYSICAL_STATE = [
  /\bpc01\b[\s\S]{0,80}(?:hoạt động|online|status|trạng thái|đang chạy|chạy chưa)/i,
  /(?:hoạt động|online|status|trạng thái|đang chạy|chạy chưa)[\s\S]{0,80}\bpc01\b/i,
