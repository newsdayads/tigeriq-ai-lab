...
describe('#775/#777 Core Ollama identity and NV09 resource registration',()=>{
  it('registers NV09 resource and health probe matching allowable path prefix',()=>{expect(coreSource).toContain("NV09_EMPLOYEE_ID = 'NV09'");expect(coreSource).toContain("R(NV09_EMPLOYEE_ID");});
