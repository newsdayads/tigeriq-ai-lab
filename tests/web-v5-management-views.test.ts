...
import { overviewCheckpointScriptV5, renderOverviewSignalsV5, renderProjectsV5, renderReportsV5, renderSettingsV5 } from '../apps/dashboard/src/management-views-v5.js';
