...
## Canonical Project Source hygiene
- Keep exactly one active canonical copy of each file listed above in ChatGPT Project “Nguồn”.
- Replace the previous copy when a file's internal Version is updated; do not upload a second stale/current duplicate under the same canonical role.
- Acceptance of a Project-behavior change requires a NEW CHAT regression in the same Project after the canonical Source files are replaced.
