...
export function acceptancePlan(mission:Mission):MissionPlan{
  ...
  return {missionId:mission.missionId,summary:'Acceptance mission: parallel analysis -> artifact -> reviewer, plus a RED authorization hold.',model:'qwen3:4b',tasks:[
...
export function parseAiPlan(mission:Mission,raw:unknown,model='qwen3:4b'):MissionPlan{
