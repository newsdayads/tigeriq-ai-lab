...
export function renderCommandOverviewV5(data: ExecutiveDashboardV4): string {
  ...
  return `<div class="cv5-shell" data-live-section="command-overview">
    ...
    <section class="cv5-kpis">${cardHtml}</section>
