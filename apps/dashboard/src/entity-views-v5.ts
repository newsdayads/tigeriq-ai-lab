...
export function renderSystemContentV5(data: ExecutiveDashboardV4, selectedId = ''): string {
  ...
  return `<div class="ev5-shell" data-live-section="entity-content"><div class="ev5-intro ev5-intro-actions"><div><h1>Hệ thống</h1><p>Máy có khỏe không — thiếu nguồn trực tiếp thì giữ trạng thái Chưa xác minh.</p></div><a class="ev5-control" href="/?view=evidence#he-thong">Mở điều khiển an toàn</a></div><div class="ev5-grid systems">${data.systems.map(systemCard).join('')}</div></div>`;
}
