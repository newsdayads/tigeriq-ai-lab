...
export function startUiAutopilotSnapshotServer({
  ...
  coreAssignmentUrl=process.env.TIGERIQ_CORE_UI_ASSIGNMENT_URL||`http://${process.env.TIGERIQ_CORE_HOST?.trim()||'127.0.0.1'}:${Number(process.env.TIGERIQ_CORE_PORT||8795)}/api/ui-assignment`,
