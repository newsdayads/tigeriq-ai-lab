...
import { normalizeTerminalWorkItems, handoffGenerationKey, evaluateChildObjectiveStates, isCodingHandoff, WORK_ITEM_STAGES, createWorkItemSchema, projectWorkItemLifecycle } from './work-handoff.mjs';
...
async function reconcileAutonomousHandoff(o){
  ...
  if(codingItems.length){
    ...
    await event('AUTONOMOUS_CODING_HANDOFF_READY',{objectiveId:o.id,generationKey:handoff.generationKe