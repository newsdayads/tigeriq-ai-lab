...
import {assertExecutionPlaneMutationPaths,controlPlaneRepairContext} from '../shared/control-plane-lock.mjs';
...
async function managerTick(){
  ...
  const mutationAuth=controlPlaneRepairContext(o.objective);
...
async function runJob(j){
  ...
  const mutationAuth=controlPlaneRepairContext(objectiveRow?.objective||'');
