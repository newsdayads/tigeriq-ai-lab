...
assert.match(publicView, /setInterval\(.*5000/);
assert.match(publicView, /PC01 LIVE/);
assert.match(publicView, /Heartbeat/);
assert.match(publicView, /Nguồn chính: PC01 Core \+ Coding Lane/);
...
assert.match(liveApi, /GitHub\/Registry fallback/);
