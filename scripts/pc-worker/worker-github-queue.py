...
STATE_PATH = Path(os.getenv('TIGERIQ_QUEUE_STATE', r'D:\TigerIQ\Worker\queue-state.json'))
WORKSPACE = Path(os.getenv('TIGERIQ_WORKSPACE', r'D:\TigerIQ\Workspace\tigeriq-ai-lab'))
