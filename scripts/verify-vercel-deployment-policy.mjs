...
console.log('Vercel deployment/routing policy PASS: Git auto-deploy disabled; routing loop-safe; explicit Production deploy is project/repo/main/SHA/Owner-scope fail-closed with bounded failure classification.');
